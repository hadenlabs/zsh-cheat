<!-- Space: Projects -->
<!-- Parent: ZshCheat -->
<!-- Title: Contributing GithubFlow ZshCheat -->
<!-- Label: ZshCheat -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-cheat project on [GitHub](https://github.com/hadenlabs/zsh-cheat), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-cheat/pulls).
...
To follow the instructions in this guide and start contributing to zsh-cheat project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-cheat.git
```

Now your **upstream** points to **hadenlabs/zsh-cheat**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-cheat
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-cheat/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
