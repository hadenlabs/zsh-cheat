...
:Version: 0.0.0
:Web: https://github.com/luismayta/zsh-cheat
:Download: https://github.com/luismayta/zsh-cheat
:Source: https://github.com/luismayta/zsh-cheat
:Keywords: zsh-cheat
...
2. Clone the plugin
    ``bash   git clone https://github.com/luismayta/zsh-cheat``\ bash
3. Edit your ``.zshrc`` and add
    ``plugins=( ... zsh-cheat )`` to your list of
    plugins
...
1. Add :
    ...
    .. code-block:: bash
        ...
        antibody bundle luismayta/zsh-cheat

    to your ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
    run ``antibody bundle luismayta/zsh-cheat`` in a
    running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-cheat.svg
    :target: https://travis-ci.org/luismayta/zsh-cheat
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-cheat.svg
    :target: https://github.com/luismayta/zsh-cheat/issues
...
.. |beacon| image:: https://ga-beacon.appspot.com/UA-65019326-1/github.com/luismayta/zsh-cheat/readme
    :target: https://github.com/luismayta/zsh-cheat
